...
acc_dt = sensor_data(:,9)/1e6;
acc_x = sensor_data(:,10);
acc_y = sensor_data(:,11);
acc_z = sensor_data(:,12);
...
for i = 2:N
    ...
    psi_hat(i) = gyro_weight*(psi_hat(i-1) + cf_r*dt) + accel_weight*psi_from_mag;
end
